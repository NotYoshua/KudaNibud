...
<head>
  ...
  <title>Регистрация — КудаНибудь</title>
...
<section class="container" style="max-width: 500px; padding: 60px 0;">
  <div style="background: white; padding: 40px; border-radius: 18px; box-shadow: 0 4px 18px rgba(0,0,0,0.08);">
    ...
    <p style="margin-top: 20px; text-align: center; opacity: 0.8;">Уже есть аккаунт? <a href="login.php" style="color: #1976d2; text-decoration: none; font-weight: 600;">Войти</a></p>
  </div>
</section>
